...
function cumlelereDonustur(cumlelerDizisi, ayrac="," ){
	let yeniDizi = cumleler.map(gelen => gelen.join(ayrac));
return yeniDizi;
}
...
function paragrafOlustur(cumlelerDizi, callBackCumleKur, callBackDonustur ){
	let yeniDizi = callBackDonustur(cumlelerDizi," ");
...
console.log(emojileriDonustur("yani hem :d hem de :D sembolleri",emojiler));
